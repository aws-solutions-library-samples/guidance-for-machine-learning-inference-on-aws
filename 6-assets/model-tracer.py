...
model_dir = "/tmp/llama2/7B" # hugging face format
...
neuron_model = neuron_model_class.from_pretrained(serialized_model_dir, tp_degree=tp_degree, batch_size=batch_size, amp=amp_type)
